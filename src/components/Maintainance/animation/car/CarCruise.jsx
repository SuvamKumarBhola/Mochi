const CarCruise = () => (
    <div className="relative w-full h-48 flex items-center justify-center">
        ...
        <div className="animate-drive relative w-48 h-24">
            <svg viewBox="0 0 200 100" className="w-full h-full drop-shadow-2xl">
                <path d="M10,70 L20,50 L60,40 L140,40 L170,50 L180,70 L180,85 L10,85 Z" fill="#06b6d4" />
                <path d="M35,50 L65,45 L130,45 L160,55 L130,55 L35,50" fill="#1f2937" />
                <circle cx="45" cy="85" r="12" fill="#111" className="animate-spin-slow" />
                <circle cx="155" cy="85" r="12" fill="#111" className="animate-spin-slow" />
            </svg>
        </div>
    </div>
);
